    ...
    return (
        <div className="row bg-light-grey padding-top-4">
            <table className="table table-striped table-bordered d-none d-lg-table">
                <thead className="txt-center"  id="crafter-table">
                    ...
                    <tr className="txt-left">
                        <td>{crafters.armoring.map((name) => {return <span>{name}<br /></span>})}</td>
                        <td>{crafters.weaponSmithing.map((name) => {return <span>{name}<br /></span>})}</td>
                        <td>{crafters.engineering.map((name) => {return <span>{name}<br /></span>})}</td>
                        <td>{crafters.jewelCrafting.map((name) => {return <span>{name}<br /></span>})}</td>
                        <td>{crafters.arcana.map((name) => {return <span>{name}<br /></span>})}</td>
                        <td>{crafters.furnishing.map((name) => {return <span>{name}<br /></span>})}</td>
                        <td>{crafters.cooking.map((name) => {return <span>{name}<br /></span>})}</td>
                    </tr>
                </thead>
            </table>
            <div className="d-lg-none row">
                ...
                <div className="col-6 border-bottom-black">
                    {crafters.weaponSmithing.map((name) => {return <span>{name}<br /></span>})}
                </div>
                <div className="col-6 border-bottom-black">
                ...
                <div className="col-6 border-bottom-black">
                    {crafters.armoring.map((name) => {return <span>{name}<br /></span>})}
                </div>
                <div className="col-6 border-bottom-black">
                ...
                <div className="col-6 border-bottom-black">
                    {crafters.engineering.map((name) => {return <span>{name}<br /></span>})}
                </div>
                <div className="col-6 border-bottom-black">
                ...
                <div className="col-6 border-bottom-black">
                    {crafters.jewelCrafting.map((name) => {return <span>{name}<br /></span>})}
                </div>
                <div className="col-6 border-bottom-black">
                ...
                <div className="col-6 border-bottom-black">
                    {crafters.arcana.map((name) => {return <span>{name}<br /></span>})}
                </div>
                <div className="col-6 border-bottom-black">
                ...
                <div className="col-6 border-bottom-black">
                    {crafters.furnishing.map((name) => {return <span>{name}<br /></span>})}
                </div>
                <div className="col-6 border-bottom-black">
                ...
                <div className="col-6 border-bottom-black">
                    {crafters.cooking.map((name) => {return <span>{name}<br /></span>})}
                </div>
            </div>
        </div>
    )
